...
$form[9][] = lang_form('input td12','wallpaper|home_all_unlocked','All unlocked');
...
$form[9][] = lang_form('input td12','wallpaper|store_restore_purchases','Restore Purchases');
$form[9][] = lang_form('input td12','wallpaper|store_restore_title','Restore');
$form[9][] = lang_form('input td12','wallpaper|store_restore_success','Purchases restored successfully!');
$form[9][] = lang_form('input td12','wallpaper|store_restore_no_purchases','No previous purchases found.');
...
$form[9][] = lang_form('input td12','wallpaper|wallpapers_go_to_store','Go to Store');
